        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a href="javascript:" @click="addOrUpdataShopCat">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  mounted() {
    // 发送请求，获取商品详情
    this.$store.dispatch('detail/getGoodsDetail', this.$route.params.id)
  },
  computed: {
    ...mapGetters('detail', [
      'categoryView',
  ...
  methods: {
    ...
    // 添加商品到购物车
    async addOrUpdataShopCat(){
      try{
        await this.$store.dispatch('detail/addOrUpdateShopCat', { skuId: this.$route.params.id ,skuNum: this.skuNum })
        // 成功 跳转路由 将数量当作查询参数传过去  还要将商品数据保存在本地
